...
class _HomePageState extends State<HomePage> {
  late Future<List<Foto>> _futurePhotos;
  ...
  Future<List<Foto>> fetchPhotos() async {
    try {
      final String apiUrl = "http://192.168.6.205/getallphotos.php";
      ...
      body: FutureBuilder<List<Foto>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return _errorWidget("Tidak ada foto yang tersedia.");
          }
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => FullScreenPhotoPage(
                        ...
                        userId: photo.userId,
                        caption: photo.deskripsi,
                        fotoId: photo.fotoid.toString(),
                      ),
                    ),
                  );
                },
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: () => setState(() => _futurePhotos = fetchPhotos()),
